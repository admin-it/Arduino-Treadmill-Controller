...
void setIncline(boolean up, boolean down){
  ...
  if(inclineCount == 20 || (distance > 14 && up == true && down == false) || (distance < 4 && up == false && down == true)){
    inclineCount = 21;
    digitalWrite(inUpRelay,LOW); 
    digitalWrite(inDownRelay,LOW);
    digitalWrite(inUp,LOW);
